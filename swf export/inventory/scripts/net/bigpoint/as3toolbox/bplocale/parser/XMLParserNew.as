package net.bigpoint.as3toolbox.bplocale.parser
{
   ...
   public class XMLParserNew implements IBPLocaleParser
   {
      ...
      public function parseXML(param1:XML) : void
      {
         ...
         for each(_loc10_ in _loc2_)
         {
            ...
            for each(_loc15_ in _loc4_)
            {
               ...
               {
                  _loc7_ = _loc15_.text();
                  BPLocale.setItemInCategory(_loc3_,_loc5_,_loc7_);
               }
               else
               {
                  ...
                  else
                  {
                     ...
                     for each(_loc19_ in _loc8_)
                     {
                        ...
                        _loc17_ = int(_loc16_);
                        BPLocale.setItemInCategory(_loc3_,_loc5_,_loc7_,_loc17_,_loc18_);
                     }
                  }
               }
            }
