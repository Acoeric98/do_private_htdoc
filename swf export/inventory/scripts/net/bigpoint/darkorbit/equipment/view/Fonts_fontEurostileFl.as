package net.bigpoint.darkorbit.equipment.view
{
   ...
   [Embed(source="/_assets/2_FontClass_1963cbb7f204_EurostileFl_net.bigpoint.darkorbit.equipment.view.Fonts_fontEurostileFl_EurostileFl.ttf",
   ...
   public class Fonts_fontEurostileFl extends FontAsset
   {
      
      public function Fonts_fontEurostileFl()
      {
         super();
      }
   }
