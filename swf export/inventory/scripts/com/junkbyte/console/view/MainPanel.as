   ...
   public class MainPanel extends ConsolePanel
   {
      ...
      private function updateFull() : void
      {
         ...
         while(_loc2_)
         {
            ...
            {
               _loc1_ = this.makeLine(_loc2_,_loc3_) + _loc1_;
            }
            _loc2_ = _loc2_.prev;
         }
         ...
         while(_loc4_)
         {
            if(this.lineShouldShow(_loc4_))
            {
               ...
               if(!(_loc4_.html || _loc2_ >= _loc6_))
               {
                  ...
                  _loc1_.push(this.makeLine(_loc4_,_loc5_));
                  break;
               }
               _loc1_.push(this.makeLine(_loc4_,_loc5_));
               _loc2_ -= _loc6_;
      ...
      {
         return (this.chShouldShow(param1.ch) || this._filterText && this._viewingChannels.indexOf(Console.FILTER_CHANNEL) >= 0 && param1.text.toLowerCase().indexOf(this._filterText) >= 0 || this._filterRegExp && this._viewingChannels.indexOf(Console.FILTER_CHANNEL) >= 0 && param1.text.search(this._filterRegExp) >= 0) && (this._priority == 0 || param1.priority >= this._priority);
      }
      ...
      private function makeLine(param1:Log, param2:Boolean) : String
      {
         ...
         if(param2 && param1.ch != Console.DEFAULT_CHANNEL)
         {
            _loc4_ = "[<a href=\"event:channel_" + param1.ch + "\">" + param1.ch + "</a>] " + _loc4_;
         }
         if(this._filterRegExp)
         {
            this._filterRegExp.lastIndex = 0;
            _loc7_ = this._filterRegExp.exec(_loc4_);
            while(_loc7_ != null)
            {
               _loc5_ = int(_loc7_.index);
               _loc8_ = _loc7_[0];
               if(_loc8_.search("<|>") >= 0)
               {
                  this._filterRegExp.lastIndex -= _loc8_.length - _loc8_.search("<|>");
               }
               else if(_loc4_.lastIndexOf("<",_loc5_) <= _loc4_.lastIndexOf(">",_loc5_))
               {
                  _loc4_ = _loc4_.substring(0,_loc5_) + "<u>" + _loc4_.substring(_loc5_,_loc5_ + _loc8_.length) + "</u>" + _loc4_.substring(_loc5_ + _loc8_.length);
         ...
         {
            _loc9_ = _loc4_.toLowerCase();
            _loc5_ = int(_loc9_.lastIndexOf(this._filterText));
            while(_loc5_ >= 0)
            {
               _loc4_ = _loc4_.substring(0,_loc5_) + "<u>" + _loc4_.substring(_loc5_,_loc5_ + this._filterText.length) + "</u>" + _loc4_.substring(_loc5_ + this._filterText.length);
               _loc5_ = int(_loc9_.lastIndexOf(this._filterText,_loc5_ - 2));
            }
         }
         var _loc6_:String = "p" + param1.priority;
         return _loc3_ + ("<p><" + _loc6_ + ">" + _loc4_ + "</" + _loc6_ + "></p>");
      }
      ...
      private function commandKeyUp(param1:KeyboardEvent) : void
      {
         ...
         if(param1.keyCode == Keyboard.ENTER)
         {
            ...
            else
            {
               ...
               if(_loc2_.length > 2)
               {
                  _loc3_ = int(this._cmdsHistory.indexOf(_loc2_));
                  while(_loc3_ >= 0)
                  {
