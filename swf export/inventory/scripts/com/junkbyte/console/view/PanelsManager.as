package com.junkbyte.console.view
{
   ...
   public class PanelsManager
   {
      ...
      public function addPanel(param1:ConsolePanel) : void
      {
         ...
         param1.addEventListener(ConsolePanel.DRAGGING,this.onPanelStartDragScale,false,0,true);
         param1.addEventListener(ConsolePanel.SCALING,this.onPanelStartDragScale,false,0,true);
      }
