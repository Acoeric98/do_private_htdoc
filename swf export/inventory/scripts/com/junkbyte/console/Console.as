package com.junkbyte.console
{
   ...
   public class Console extends Sprite
   {
      ...
      public static const BUILD_DATE:String = "2011/08/21 20:50";
      ...
      private function _onEnterFrame(param1:Event) : void
      {
         ...
         var _loc2_:Boolean = this._logs.update();
         this._refs.update();
         this._mm.update();
         if(this.remoter.remoting != Remoting.RECIEVER)
         {
            _loc3_ = this._graphing.update(stage ? stage.frameRate : 0);
         }
         ...
         if(visible && Boolean(parent))
         {
            ...
            this._panels.update(this._paused,_loc2_);
            if(_loc3_)
            {
               this._panels.updateGraphs(_loc3_);
            }
         }
      }
