      ...
      override public function renderTime(param1:Number, param2:Boolean = false, param3:Boolean = false) : void
      {
         ...
         if(_repeat != 0)
         {
            ...
            else if(param1 > 0)
            {
               ...
               _cyclesComplete = this.cachedTotalTime / _loc10_ >> 0;
               ...
               while(_loc7_)
               {
                  if(_loc7_.name == _loc2_)
                  {
                     ...
                     else
                     {
                        if(_loc5_ == null)
                        {
                           _loc5_ = new TweenLite.plugins.roundProps();
                           _loc5_.add(_loc7_.target,_loc2_,_loc7_.start,_loc7_.change);
                           _hasPlugins = true;
                           this.cachedPT1 = _loc6_ = insertPropTween(_loc5_,"changeFactor",0,1,"_MULTIPLE_",true,this.cachedPT1);
                        }
                        else
                        {
                           _loc5_.add(_loc7_.target,_loc2_,_loc7_.start,_loc7_.change);
